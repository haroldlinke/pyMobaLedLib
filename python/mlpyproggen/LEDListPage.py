...
from mlpyproggen.DefaultConstants import COLORCOR_MAX, DEFAULT_PALETTE, LARGE_FONT, SMALL_FONT, VERY_LARGE_FONT, PROG_VERSION, PERCENT_BRIGHTNESS
...
class Frame_1(tk.Frame):
    ...
    def __init__(self,master,parent, controller):
        ...
        for key in sorted(self.controller.ledtable):
            ...
            keyeffect = self.controller.ledeffecttable.get(key,"")
