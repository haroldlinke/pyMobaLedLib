...
class VB2PYPage(tk.Frame):

    def __init__(self, parent, controller):
        self.controller = controller
        self.arduino_portlist = {}
        tk.Frame.__init__(self,parent)
        self.tabClassName = "VB2PYPage"
...
#
        ...
        self.startConvbutton = ttk.Button(startConvPath_frame, text=button5_text,width=30, command=self.startConversion)
    ...
    def startConversion (self):
        project_file = self.ProgGen_Excel_filename
        if project_file == "":
            project_file = "test"
        destination_dir = "output"
        CommandStr = "Python3 startprojectconverter.py -d " + project_file + " " + destination_dir
        ...
        ProgDir = os.path.dirname(os.path.realpath(__file__)) + "/../vb2pyconv"
        P01.ChDir(ProgDir)
        #print(ProgDir)
        #print(CommandStr)
        res = PG.dialog_parent.execute_shell_cmd(CommandStr,"VB2PY started")
