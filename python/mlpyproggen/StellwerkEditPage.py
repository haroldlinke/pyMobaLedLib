...
#import pyStwEditor.GbeditP501 as pyStwEditor
...
class StellwerkEditPage(tk.Frame):

    def __init__(self, parent, controller):
        self.controller = controller
        self.arduino_portlist = {}
        tk.Frame.__init__(self,parent)
        self.tabClassName = "StellwerkEditPage"
        ...
        #pyStwEditor.pyStw_Start(self.main_frame, self.controller)
