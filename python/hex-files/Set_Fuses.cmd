@ECHO OFF
REM This file was generated by 'PatternWorkbook'  1737018393.36087
...
REM   Chip:               'ATTiny85'
REM   B.O.D.Level:        'B.O.D. Enabled (2.7V) Eckhart-Boot'
...
ECHO Unterspannungserkennung (B.O.D. Level 'B.O.D. Enabled (2.7V) Eckhart-Boot')
...
"%USERPROFILE%\AppData\Local\Arduino15\packages\arduino\tools\avrdude\6.3.0-arduino18\bin\avrdude.exe" ^
    ...
    -Uefuse:w:0xFE:m -Uhfuse:w:0x55:m -Ulfuse:w:0xE1:m
...
IF ERRORLEVEL 1 (
    ...
    "%USERPROFILE%\AppData\Local\Arduino15\packages\arduino\tools\avrdude\6.3.0-arduino18\bin\avrdude.exe" ^
        "-C%USERPROFILE%\AppData\Local\Arduino15\packages\ATTinyCore\hardware\avr\1.5.2\avrdude.conf"  ^
        -v -pattiny85 -cstk500v1 -P%ComPort% -b19200 ^
        -Uefuse:w:0xFF:m -Uhfuse:w:0x55:m -Ulfuse:w:0xE1:m
...
IF ERRORLEVEL 1 (
   REM White on RED
   COLOR 4F
   ECHO Set_Fuses Result: %ERRORLEVEL% > "Write_Fuses_Result.txt"
   ECHO   *********************************************
