...
// File creation: 02/07/25 19:10:04
...
#define START_MSG "LEDs_AutoProg Ver 1: 02.07.25 19:10"
...
const PROGMEM Ext_Addr_T Ext_Addr[] =
         ...
         { // Addr & Typ    InCnt
           { 100  + B_RED,     3 },      // Servo 1
           { 108  + S_ONOFF,   1 },      // Kanal 0 - Rück LED
           { 102  + S_ONOFF,   1 },      // Kanal 1
           { 103  + S_ONOFF,   1 },      // Kanal 2
           { 104  + S_ONOFF,   1 },      // Kanal 3
           { 105  + S_ONOFF,   1 },      // Kanal 4
           { 106  + S_ONOFF,   1 },      // Kanal 5
           { 107  + S_ONOFF,   1 },      // Kanal 6
         };


// Input channel defines for local inputs and expert users
#define INCH_DCC_100_RED        0      // Servo 1
#define INCH_DCC_100_GREEN      1      //     "
#define INCH_DCC_101_RED        2      //     "
#define INCH_DCC_108_ONOFF      3      // Kanal 0 - Rück LED
#define INCH_DCC_102_ONOFF      4      // Kanal 1
#define INCH_DCC_103_ONOFF      5      // Kanal 2
#define INCH_DCC_104_ONOFF      6      // Kanal 3
#define INCH_DCC_105_ONOFF      7      // Kanal 4
#define INCH_DCC_106_ONOFF      8      // Kanal 5
#define INCH_DCC_107_ONOFF      9      // Kanal 6
...
MobaLedLib_Configuration()
  {
  RGB_Heartbeat2(0, 5, 64)                                                                                    /* LED auf dem Mainboard                                                                                                                                                                       */
  // #ServoAnim(0,2,500,20,220,2500,2500,0,0,0,0,1,1,0,1,1)                                                   /* Servo 1 Animation                                                                                                                                                                           */
  APatternT1(0,28,SI_1,1,0,128,0,PM_NORMAL,500,20,106,172,134,180,220,180,140,100,60,20)                      /*     "                                                                                                                                                                                       */
  Servo3(0, 0, C1, 10, 115, 210, 10 Sek)                                                                      /* Servo 1                                                                                                                                                                                     */
  ConstRGB(0, SI_1, 0, 0, 0, 127, 127, 127)                                                                   /* Servo 2                                                                                                                                                                                     */
  ConstRGB(0, SI_1, 0, 0, 0, 0, 127, 0)                                                                       /* Servo 3                                                                                                                                                                                     */
  ConstRGB(0, 3, 0, 0, 0, 0, 0, 64)                                                                           /* Kanal 0 - Rück LED                                                                                                                                                                          */
  ConstRGB(0, 4, 0, 0, 0, 0, 0, 64)                                                                           /* Kanal 1                                                                                                                                                                                     */
  ConstRGB(0, 5, 0, 0, 0, 0, 0, 64)                                                                           /* Kanal 2                                                                                                                                                                                     */
  ConstRGB(0, 6, 0, 0, 0, 0, 0, 64)                                                                           /* Kanal 3                                                                                                                                                                                     */
  ConstRGB(0, 7, 0, 0, 0, 0, 0, 64)                                                                           /* Kanal 4                                                                                                                                                                                     */
  ConstRGB(0, 8, 0, 0, 0, 0, 0, 64)                                                                           /* Kanal 5                                                                                                                                                                                     */
  ConstRGB(0, 9, 0, 0, 0, 0, 0, 64)                                                                           /* Kanal 6                                                                                                                                                                                     */
...
const PROGMEM Store_Channel_T Store_Values[] =
         { // Mode + InCnt , Channel
           { IS_TOGGLE + 1 , INCH_DCC_108_ONOFF  },      // Kanal 0 - Rück LED
           { IS_TOGGLE + 1 , INCH_DCC_102_ONOFF  },      // Kanal 1
           { IS_TOGGLE + 1 , INCH_DCC_103_ONOFF  },      // Kanal 2
           { IS_TOGGLE + 1 , INCH_DCC_104_ONOFF  },      // Kanal 3
           { IS_TOGGLE + 1 , INCH_DCC_105_ONOFF  },      // Kanal 4
           { IS_TOGGLE + 1 , INCH_DCC_106_ONOFF  },      // Kanal 5
           { IS_TOGGLE + 1 , INCH_DCC_107_ONOFF  },      // Kanal 6
         };
