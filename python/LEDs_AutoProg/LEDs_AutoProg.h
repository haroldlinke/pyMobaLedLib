...
// File creation: 07/08/24 09:01:31
...
#define START_MSG "LEDs_AutoProg Ver 1: 07.08.24 09:01"
...
const PROGMEM Ext_Addr_T Ext_Addr[] =
         ...
         { // Addr & Typ    InCnt
           ...
           { 104  + S_ONOFF,   1 },      // Excel row 7
         };


// Input channel defines for local inputs and expert users
#define INCH_DCC_102_ONOFF      0      // Excel row 6
#define INCH_DCC_104_ONOFF      1      // Excel row 7


//*** Direct connected switches ***

#define START_SWITCHES_D  2                                        // Define the start number for the first mainboard switch
#define SwitchD1                2
...
MobaLedLib_Configuration()
  ...
  // #ServoAnim(0,0,500,20,220,2500,2500,0,0,0,0,1,0,0,0)                                                     /* Excel row 7                                                                                                                                                                                 */
  APatternT1(3,28,1,3,0,128,0,PM_NORMAL,500,20,1,0,60,1,0,100,1,0,140,1,0,180,1,0,220,1,0,180,1,0,140,1,0,100,1,0,60,1,0,20,1,0) /*     "                                                                                                                                                                    */
...
const PROGMEM Store_Channel_T Store_Values[] =
         { // Mode + InCnt , Channel
           ...
           { IS_TOGGLE + 1 , INCH_DCC_104_ONOFF  },      // Excel row 7
         };
