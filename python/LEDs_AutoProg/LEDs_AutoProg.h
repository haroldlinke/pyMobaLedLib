...
// File creation: 02/04/25 11:04:18
...
#define START_MSG "LEDs_AutoProg Ver 1: 02.04.25 11:04"
...
#define LEDS_PER_CHANNEL ",14,1,1,1,1,1,1"
...
/*********************/                                                      \
  ...
  CLEDController& controller1 = FastLED.addLeds<NEOPIXEL, 32>(leds+ 14,  1); \
...
MobaLedLib_Configuration()
  ...
  Servo3(1, 0, C1, 10, 115, 210, 10 Sek)                                                                      /* Servo 1                                                                                                                                                                                     */
  ConstRGB(2, SI_1, 0, 0, 0, 127, 127, 127)                                                                   /* Servo 2                                                                                                                                                                                     */
  ConstRGB(3, SI_1, 0, 0, 0, 0, 127, 0)                                                                       /* Servo 3                                                                                                                                                                                     */
  ConstRGB(4, 3, 0, 0, 0, 0, 0, 64)                                                                           /* Kanal 0 - Rück LED                                                                                                                                                                          */
  ConstRGB(14, 4, 0, 0, 0, 0, 0, 64)                                                                          /* Kanal 1                                                                                                                                                                                     */
  ConstRGB(15, 5, 0, 0, 0, 0, 0, 64)                                                                          /* Kanal 2                                                                                                                                                                                     */
  ConstRGB(16, 6, 0, 0, 0, 0, 0, 64)                                                                          /* Kanal 3                                                                                                                                                                                     */
  ConstRGB(17, 7, 0, 0, 0, 0, 0, 64)                                                                          /* Kanal 4                                                                                                                                                                                     */
  ConstRGB(18, 8, 0, 0, 0, 0, 0, 64)                                                                          /* Kanal 5                                                                                                                                                                                     */
  ConstRGB(19, 9, 0, 0, 0, 0, 0, 64)                                                                          /* Kanal 6                                                                                                                                                                                     */
