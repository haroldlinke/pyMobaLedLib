...
// File creation: 04/06/22 19:26:04
...
#define START_MSG "LEDs_AutoProg Ver 1: 04/06/22 19:26:04"
...
#endif
         { // Addr & Typ    InCnt
           { 100  + S_ONOFF, 1 },      // Excel row 3           { 101  + S_ONOFF, 1 },      // Excel row 5         };


// Input channel defines for local inputs and expert users
#define INCH_DCC_100_ONOFF      0      // Excel row 3#define INCH_DCC_101_ONOFF      1      // Excel row 5
...
MobaLedLib_Configuration()
  {
  ConstrWarnLightRGB6(0, 0, 5, 255, 100 ms, 0 ms, 500 ms)                                                     /* Excel row 3                                                                                                                                                                                 */  House(6, 1, 1, 3, ROOM_DARK, ROOM_BRIGHT, ROOM_WARM_W, ROOM_RED)                                            /* Excel row 5                                                                                                                                                                                 */  ConstrWarnLightRGB6(10, SI_1, 5, 255, 100 ms, 0 ms, 500 ms)                                                 /* Excel row 6                                                                                                                                                                                 */
...
// Definition of channels and counters that need to store state in EEPromconst PROGMEM Store_Channel_T Store_Values[] =         { // Mode + InCnt , Channel
           { IS_TOGGLE + 1 , INCH_DCC_100_ONOFF  },      // Excel row 3           { IS_TOGGLE + 1 , INCH_DCC_101_ONOFF  },      // Excel row 5         };
