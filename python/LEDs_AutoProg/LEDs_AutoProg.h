...
// File creation: 04/05/24 15:12:43
...
#define START_MSG "LEDs_AutoProg Ver 1: 04.05.24 15:12"
...
#endif
         { // Addr & Typ    InCnt
           { 100  + S_ONOFF,   1 },      // dcc test
         };


// Input channel defines for local inputs and expert users
#define INCH_DCC_100_ONOFF      0      // dcc test
...
MobaLedLib_Configuration()
  ...
  // Activation: Binary #ServoAnim(0,0,500,20,220,2500,2500,0,0,0,0,1,0)                                      /* dcc test                                                                                                                                                                                    */
...
const PROGMEM Store_Channel_T Store_Values[] =
         { // Mode + InCnt , Channel
           { IS_TOGGLE + 1 , INCH_DCC_100_ONOFF  },      // dcc test
         };
