...
// File creation: 04/20/24 14:16:29
...
#define START_MSG "LEDs_AutoProg Ver 1: 04.20.24 14:16"
...
#endif
         { // Addr & Typ    InCnt
           { 102  + S_ONOFF,   1 },      // Farbverlauf
         };


// Input channel defines for local inputs and expert users
#define INCH_DCC_102_ONOFF      0      // Farbverlauf
...
MobaLedLib_Configuration()
  {
  New_HSV_Group()                                                                                             /* Excel row 8                                                                                                                                                                                 */
  // Activation: Binary #LEDColorAnim(0,0,500,0,255,2500,1,0,0,0,0,1)                                         /* Farbverlauf                                                                                                                                                                                 */
  Bin_InCh_to_TmpVar(0, 1.0)                                                                                  /*     "                                                                                                                                                                                       */
  APatternT1(0,28,0,3,0,128,0,PM_HSV,500,0,255,255,51,255,255,102,255,255,153,255,255,204,255,255,255,255,255) /*     "                                                                                                                                                                                      */
...
const PROGMEM Store_Channel_T Store_Values[] =
         { // Mode + InCnt , Channel
           { IS_TOGGLE + 1 , INCH_DCC_102_ONOFF  },      // Farbverlauf
         };
