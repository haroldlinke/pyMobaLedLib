...
//
// It was automatically generated by the program PyProgramWorkbook Ver. 3.2.1      by Hardi
// File creation: 08/11/22 18:28:42
...
#define START_MSG "LEDs_AutoProg Ver 1: Ver_3.2.1 08.11.22 18:28"
...
#define INCH_DCC_100_ONOFF      0      // test
...
MobaLedLib_Configuration()
  {
  RGB_Heartbeat(0)                                                                                            /* LED auf dem Mainboard                                                                                                                                                                       */  ConstrWarnLightRGB6(1, 0, 5, 255, 100 ms, 0 ms, 500 ms)                                                     /* test                                                                                                                                                                                        */  ConstrWarnLightRGB6(7, SI_1, 5, 255, 100 ms, 0 ms, 500 ms)                                                  /* Excel row 6                                                                                                                                                                                 */
...
// Definition of channels and counters that need to store state in EEPromconst PROGMEM Store_Channel_T Store_Values[] =         { // Mode + InCnt , Channel
           { IS_TOGGLE + 1 , INCH_DCC_100_ONOFF  },      // test         };
