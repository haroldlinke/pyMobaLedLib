...
// File creation: 04/15/22 16:53:34
...
#define START_MSG "LEDs_AutoProg Ver 1: 04/15/22 16:53:34"
...
MobaLedLib_Configuration()
  {
  ConstrWarnLightRGB6(0, 0, 5, 255, 100 ms, 0 ms, 500 ms)                                                     /* Excel row 4                                                                                                                                                                                 */  Const(6, C_ALL, 1, 0, 127)                                                                                  /* Excel row 6                                                                                                                                                                                 */  ConstrWarnLightRGB6(7, SI_1, 5, 255, 100 ms, 0 ms, 500 ms)                                                  /* Excel row 7                                                                                                                                                                                 */  ConstRGB(13, SI_1, 0, 0, 0, 127, 127, 127)                                                                  /* Excel row 8                                                                                                                                                                                 */  Blinker(14, C_ALL, SI_1, 1 Sek)                                                                             /* Excel row 9                                                                                                                                                                                 */
