...
// File creation: 03/29/25 13:23:40
...
#define START_MSG "LEDs_AutoProg Ver 1: 03.29.25 13:23"

#define TWO_BUTTONS_PER_ADDRESS 1      // Two buttons (Red/Green) are used (DCC/LNet/CAN)
#ifdef NUM_LEDS
  #warning "'NUM_LEDS' definition in the main program is replaced by the included 'LEDs_AutoProg.h' with 273"
  #undef NUM_LEDS
#endif

#define NUM_LEDS 273                   // Number of LEDs (Maximal 256 RGB LEDs could be used)

#define LEDS_PER_CHANNEL ",248,2,2,2,2,2,0,15"
...
/*********************/                                                      \
  CLEDController& controller0 = FastLED.addLeds<NEOPIXEL, 27>(leds+  0,248); \
  CLEDController& controller1 = FastLED.addLeds<NEOPIXEL, 32>(leds+248,  2); \
  CLEDController& controller2 = FastLED.addLeds<NEOPIXEL, 16>(leds+250,  2); \
  CLEDController& controller3 = FastLED.addLeds<NEOPIXEL, 14>(leds+252,  2); \
  CLEDController& controller4 = FastLED.addLeds<NEOPIXEL, 18>(leds+254,  2); \
  CLEDController& controller5 = FastLED.addLeds<NEOPIXEL, 19>(leds+256,  2); \
  CLEDController& controller7 = FastLED.addLeds<NEOPIXEL,  0>(leds+258, 15); \
                                                                             \
...
MobaLedLib_Configuration()
  {
  // Set_LED_OutpPinLst(27 32 16 14 18 19 23 0 17)                                                            /* Excel row 3                                                                                                                                                                                 */
  ...
  RGB_Heartbeat_Color(248, 60, 120, 150, 1 Sek)                                                               /* Kanal 1 Heartbeat ausgehend (deaktivieren bei PushButtons)                                                                                                                                  */
  RGB_Heartbeat_Color(250, 60, 120, 150, 1 Sek)                                                               /* Kanal 2 Heartbeat ausgehend                                                                                                                                                                 */
  RGB_Heartbeat_Color(252, 60, 120, 150, 1 Sek)                                                               /* Kanal 3 Heartbeat ausgehend                                                                                                                                                                 */
  RGB_Heartbeat_Color(254, 60, 120, 150, 1 Sek)                                                               /* Kanal 4 Heartbeat ausgehend                                                                                                                                                                 */
  RGB_Heartbeat_Color(256, 60, 120, 150, 1 Sek)                                                               /* Kanal 5 Heartbeat ausgehend                                                                                                                                                                 */
  Const(258, C1, D1, 9, 255)                                                                                  /* Status-LED gelb                                                                                                                                                                             */
  Const(258, C2, D2, 3, 90)                                                                                   /* Status-LED weiß                                                                                                                                                                             */
  Const(258, C3, D3, 5, 180)                                                                                  /* Status-LED blau                                                                                                                                                                             */
  RGB_Ring(259, SI_1, 10, 300)                                                                                /* MLL-Ring (pc)                                                                                                                                                                               */
  RGB_Heartbeat_Color(271, 5, 120, 150, 1 Sek)                                                                /* Kanal 7 Heartbeat ausgehend                                                                                                                                                                 */
  ...
  Flash(104, C2, Licht_OutG, LOC_INCH2, 500, 500)                                                             /* Excel row 233                                                                                                                                                                               */
  Flash(105, C2, Licht_OutG, LOC_INCH3, 500, 500)                                                             /* Excel row 234                                                                                                                                                                               */
  Flash(106, C2, Licht_OutG, LOC_INCH4, 500, 500)                                                             /* Excel row 235                                                                                                                                                                               */
  Flash(107, C2, Licht_OutG, LOC_INCH5, 500, 500)                                                             /* Excel row 236                                                                                                                                                                               */
  Flash(108, C2, Licht_OutG, LOC_INCH6, 500, 500)                                                             /* Excel row 237                                                                                                                                                                               */
  // Next_LED(-6)                                                                                             /* Excel row 239                                                                                                                                                                               */
  Flash(103, C23, Licht_OutB, LOC_INCH7, 500, 500)                                                            /* Licht Blau - ESU                                                                                                                                                                            */
  Flash(104, C23, Licht_OutB, LOC_INCH8, 500, 500)                                                            /* Excel row 241                                                                                                                                                                               */
  Flash(105, C23, Licht_OutB, LOC_INCH9, 500, 500)                                                            /* Excel row 242                                                                                                                                                                               */
  Flash(106, C23, Licht_OutB, LOC_INCH10, 500, 500)                                                           /* Excel row 243                                                                                                                                                                               */
  Flash(107, C23, Licht_OutB, LOC_INCH11, 500, 500)                                                           /* Excel row 244                                                                                                                                                                               */
  Flash(108, C23, Licht_OutB, LOC_INCH12, 500, 500)                                                           /* Excel row 245                                                                                                                                                                               */
  // Next_LED(-6)                                                                                             /* Excel row 247                                                                                                                                                                               */
  Flash(103, C12, Licht_OutY, LOC_INCH13, 500, 500)                                                           /* Licht Gelb - Zimo                                                                                                                                                                           */
  Flash(104, C12, Licht_OutY, LOC_INCH14, 500, 500)                                                           /* Excel row 249                                                                                                                                                                               */
  Flash(105, C12, Licht_OutY, LOC_INCH15, 500, 500)                                                           /* Excel row 250                                                                                                                                                                               */
  Flash(106, C12, Licht_OutY, LOC_INCH16, 500, 500)                                                           /* Excel row 251                                                                                                                                                                               */
  Flash(107, C12, Licht_OutY, LOC_INCH17, 500, 500)                                                           /* Excel row 252                                                                                                                                                                               */
  Flash(108, C12, Licht_OutY, LOC_INCH18, 500, 500)                                                           /* Excel row 253                                                                                                                                                                               */
  // Next_LED(-6)                                                                                             /* Excel row 255                                                                                                                                                                               */
  Flash(103, C_ALL, Licht_OutW, LOC_INCH19, 500, 500)                                                         /* Licht Weiß - Reserve                                                                                                                                                                        */
  Flash(104, C_ALL, Licht_OutW, LOC_INCH20, 500, 500)                                                         /* Excel row 257                                                                                                                                                                               */
  Flash(105, C_ALL, Licht_OutW, LOC_INCH21, 500, 500)                                                         /* Excel row 258                                                                                                                                                                               */
  Flash(106, C_ALL, Licht_OutW, LOC_INCH22, 500, 500)                                                         /* Excel row 259                                                                                                                                                                               */
  Flash(107, C_ALL, Licht_OutW, LOC_INCH23, 500, 500)                                                         /* Excel row 260                                                                                                                                                                               */
  Flash(108, C_ALL, Licht_OutW, LOC_INCH24, 500, 500)                                                         /* Excel row 261                                                                                                                                                                               */
  // Next_LED(-6)                                                                                             /* Excel row 263                                                                                                                                                                               */
  Flash(103, C1, Licht_OutR, LOC_INCH25, 500, 500)                                                            /* Licht Rot - Fehler                                                                                                                                                                          */
  Flash(104, C1, Licht_OutR, LOC_INCH26, 500, 500)                                                            /* Excel row 265                                                                                                                                                                               */
  Flash(105, C1, Licht_OutR, LOC_INCH27, 500, 500)                                                            /* Excel row 266                                                                                                                                                                               */
  Flash(106, C1, Licht_OutR, LOC_INCH28, 500, 500)                                                            /* Excel row 267                                                                                                                                                                               */
  Flash(107, C1, Licht_OutR, LOC_INCH29, 500, 500)                                                            /* Excel row 268                                                                                                                                                                               */
  Flash(108, C1, Licht_OutR, LOC_INCH30, 500, 500)                                                            /* Excel row 269                                                                                                                                                                               */
  ...
  GasLights(213, INCH_DCC_100_ONOFF, NEON_LIGHT1D, SINGLE_LED2)                                               /* Excel row 387                                                                                                                                                                               */
  ...
  RGB_Heartbeat_Color(247, 60, 120, 205, 1 Sek)                                                               /* Kanal 0N Heartbeat Rückmeldung                                                                                                                                                              */
  RGB_Heartbeat_Color(249, 60, 120, 205, 1 Sek)                                                               /* Kanal 1N Heartbeat Rückmeldung (deaktivieren bei PushButtons)                                                                                                                               */
  RGB_Heartbeat_Color(251, 60, 120, 205, 1 Sek)                                                               /* Kanal 2N Heartbeat Rückmeldung                                                                                                                                                              */
  RGB_Heartbeat_Color(253, 60, 120, 205, 1 Sek)                                                               /* Kanal 3N Heartbeat Rückmeldung                                                                                                                                                              */
  RGB_Heartbeat_Color(255, 60, 120, 205, 1 Sek)                                                               /* Kanal 4N Heartbeat Rückmeldung                                                                                                                                                              */
  RGB_Heartbeat_Color(257, 60, 120, 205, 1 Sek)                                                               /* Kanal 5N Heartbeat Rückmeldung                                                                                                                                                              */
  RGB_Heartbeat_Color(272, 60, 120, 205, 1 Sek)                                                               /* Kanal 7N Heartbeat Rückmeldung                                                                                                                                                              */
