...
// File creation: 04/18/22 11:52:38
...
#define START_MSG "LEDs_AutoProg Ver 1: 04/18/22 11:52:38"
...
#endif
         { // Addr & Typ    InCnt
           { 120  + B_RED,   3 },      // Excel row 4           { 124  + B_RED,   4 },      // Excel row 5         };


// Input channel defines for local inputs and expert users
#define INCH_DCC_120_RED        0      // Excel row 4#define INCH_DCC_120_GREEN      1      //     "#define INCH_DCC_121_RED        2      //     "#define INCH_DCC_124_RED        3      // Excel row 5#define INCH_DCC_124_GREEN      4      //     "#define INCH_DCC_125_RED        5      //     "#define INCH_DCC_125_GREEN      6      //     "
...
MobaLedLib_Configuration()
  {
  RGB_Heartbeat(0)                                                                                            /* LED auf dem Mainboard                                                                                                                                                                       */  EntrySignal3_RGB(1, 0)                                                                                      /* Excel row 4                                                                                                                                                                                 */  DepSignal4_RGB(4, 3, 128)                                                                                   /* Excel row 5                                                                                                                                                                                 */
...
// Definition of channels and counters that need to store state in EEPromconst PROGMEM Store_Channel_T Store_Values[] =         { // Mode + InCnt , Channel
           { IS_PULSE  + 3 , INCH_DCC_120_RED    },      // Excel row 4           { IS_PULSE  + 4 , INCH_DCC_124_RED    },      // Excel row 5         };
