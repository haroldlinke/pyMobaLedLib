...
// File creation: 05/12/24 11:23:22
...
#define START_MSG "LEDs_AutoProg Ver 1: 05.12.24 11:23"
...
MobaLedLib_Configuration()
  ...
  // #LEDColorAnim(0,0,500,128,255,255,128,255,255,2500,0,0,0)                                                /* Excel row 7                                                                                                                                                                                 */
  APatternT3(0,28,SI_1,3,0,128,0,PM_HSV,1250,0,1250,128,255,255,255,255,255,0,255,255,128,255,255)            /*     "                                                                                                                                                                                       */
  // #LEDColorAnim(0,2,625,20,255,255,20,255,255,2500,0,0,0)                                                  /* Excel row 8                                                                                                                                                                                 */
  APatternT3(1,28,SI_1,3,0,255,0,PM_HSV,2305,0,195,255,255,255,0,255,255,20,255,255)                          /*     "                                                                                                                                                                                       */
