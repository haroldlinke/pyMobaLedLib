...
// File creation: 05/30/24 10:13:43
...
#define START_MSG "LEDs_AutoProg Ver 1: 05.30.24 10:13"
...
MobaLedLib_Configuration()
  ...
  // Activation: Binary #ServoAnim(2,0,500,20,220,2500,2500,0,0,0,0,1,0,0)                                    /* Excel row 4                                                                                                                                                                                 */
  Bin_InCh_to_TmpVar(0, 1.0)                                                                                  /*     "                                                                                                                                                                                       */
  APatternT1(1,28,SI_LocalVar,3,0,128,0,PM_NORMAL,500,20,1,0,60,1,0,100,1,0,140,1,0,180,1,0,220,1,0,180,1,0,140,1,0,100,1,0,60,1,0,20,1,0  ,0,0,0,0,0,63,128,0,0,0,63) /*     "                                                                                                                              */
