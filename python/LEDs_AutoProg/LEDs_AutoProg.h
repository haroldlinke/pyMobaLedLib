...
// File creation: 02/07/26 19:04:58
...
#define START_MSG "LEDs_AutoProg Ver 3: AM328 3.5.0C1 02.07.26 19:04"
...
MobaLedLib_Configuration()
  ...
  GasLights(1, SI_1, GAS_LIGHT1D)                                                                             /* Eckhaus Wandlampe                                                                                                                                                                           */
  // Next_LED(-1)                                                                                             /* Excel row 19                                                                                                                                                                                */
  GasLights(1, SI_1, GAS_LIGHT2D)                                                                             /* EckhausWandlampe                                                                                                                                                                            */
