...
// File creation: 03/04/25 17:11:09
...
#define START_MSG "LEDs_AutoProg Ver 1: 03.04.25 17:11"
...
#define INCH_DCC_102_ONOFF      3      // Excel row 8
...
MobaLedLib_Configuration()
  ...
  Const(12, C_ALL, SI_1, 0, 0)                                                                                /* Excel row 6                                                                                                                                                                                 */
  Const(13, C_ALL, SI_1, 0, 0)                                                                                /* Excel row 7                                                                                                                                                                                 */
  Const(14, C_ALL, 3, 0, 127)                                                                                 /* Excel row 8                                                                                                                                                                                 */
  RGB_Heartbeat(15)                                                                                           /* Excel row 10                                                                                                                                                                                */
  RGB_Heartbeat(16)                                                                                           /* Excel row 11                                                                                                                                                                                */
  RGB_Heartbeat(17)                                                                                           /* Excel row 12                                                                                                                                                                                */
  RGB_Heartbeat(18)                                                                                           /* Excel row 13                                                                                                                                                                                */
  RGB_Heartbeat(19)                                                                                           /* Excel row 14                                                                                                                                                                                */
...
const PROGMEM Store_Channel_T Store_Values[] =
         { // Mode + InCnt , Channel
           { IS_TOGGLE + 1 , INCH_DCC_102_ONOFF  },      // Excel row 8
         };
