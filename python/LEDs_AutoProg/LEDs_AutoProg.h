...
// File creation: 08/31/24 18:16:29
...
#define START_MSG "LEDs_AutoProg Ver 1: 08.31.24 18:16"
...
MobaLedLib_Configuration()
  ...
  // Activation: Binary #ServoAnim(2,2,500,20,220,2500,2500,0,0,0,0,2,0,0,0)                                  /* Excel row 5                                                                                                                                                                                 */
  Bin_InCh_to_TmpVar(0, 1)                                                                                    /*     "                                                                                                                                                                                       */
  #define ENABLE_STORE_STATUS()                                                                               /*     "                                                                                                                                                                                       */
  APatternT3(1,28,SI_LocalVar,3,0,128,0,PM_NORMAL,520,480,500,20,1,2,63,1,2,100,1,2,140,1,2,180,1,2,220,1,3,180,1,4,140,1,4,100,1,4,60,1,4,20,1,5  ,0,0,0,0,0,63,128,0,0,0,63) /*     "                                                                                                                      */
