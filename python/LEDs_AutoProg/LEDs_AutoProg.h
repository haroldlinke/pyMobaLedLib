...
// File creation: 01/30/25 18:43:10
...
#define START_MSG "LEDs_AutoProg Ver 1: 01.30.25 18:43"
...
MobaLedLib_Configuration()
  {
  RGB_Heartbeat2(0, 5, 127)                                                                                   /* LED auf dem Mainboard                                                                                                                                                                       */
  // #ServoAnim(0,0,500,20,220,2500,2500,0,0,0,0,0,1,0,0,1)                                                   /* Excel row 4                                                                                                                                                                                 */
  APatternT1(1,28,0,1,0,128,0,PM_NORMAL,1250,20,120,220,120,20)                                               /*     "                                                                                                                                                                                       */
