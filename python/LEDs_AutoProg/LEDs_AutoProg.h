...
// File creation: 05/18/24 17:04:32
...
#define START_MSG "LEDs_AutoProg Ver 1: 05.18.24 17:04"
...
#endif
         { // Addr & Typ    InCnt
           { 100  + S_ONOFF,   1 },      // Excel row 16
           { 101  + S_ONOFF,   1 },      // Excel row 17
         };


// Input channel defines for local inputs and expert users
#define INCH_DCC_100_ONOFF      0      // Excel row 16
#define INCH_DCC_101_ONOFF      1      // Excel row 17
...
MobaLedLib_Configuration()
  ...
  // #ServoAnim(0,0,500,20,220,2500,2500,0,0,0,0,1,0)                                                         /* Excel row 16                                                                                                                                                                                */
  APatternT1(1,28,0,3,0,128,0,PM_NORMAL,500,20,1,0,60,1,0,100,1,0,140,1,0,180,1,0,220,1,0,180,1,0,140,1,0,100,1,0,60,1,0,20,1,0) /*     "                                                                                                                                                                    */
  // Activation: Binary #ServoAnim(2,0,500,20,220,2500,2500,0,0,0,0,1,0)                                      /* Excel row 17                                                                                                                                                                                */
  Bin_InCh_to_TmpVar(1, 1.0)                                                                                  /*     "                                                                                                                                                                                       */
  APatternT1(2,28,SI_LocalVar,3,0,128,0,PM_NORMAL,500,20,1,0,60,1,0,100,1,0,140,1,0,180,1,0,220,1,0,180,1,0,140,1,0,100,1,0,60,1,0,20,1,0  ,0,0,0,0,0,63,128,0,0,0,63) /*     "                                                                                                                              */
...
const PROGMEM Store_Channel_T Store_Values[] =
         { // Mode + InCnt , Channel
           { IS_TOGGLE + 1 , INCH_DCC_100_ONOFF  },      // Excel row 16
           { IS_TOGGLE + 1 , INCH_DCC_101_ONOFF  },      // Excel row 17
         };
