...
// File creation: 02/03/25 18:24:23
...
#define START_MSG "LEDs_AutoProg Ver 1: 02.03.25 18:24"
...
#endif
         { // Addr & Typ    InCnt
           { 100  + B_RED,     2 },      // Excel row 4
           { 101  + S_ONOFF,   1 },      // Excel row 7
         };


// Input channel defines for local inputs and expert users
#define INCH_DCC_100_RED        0      // Excel row 4
#define INCH_DCC_100_GREEN      1      //     "
#define INCH_DCC_101_ONOFF      2      // Excel row 7
...
MobaLedLib_Configuration()
  ...
  Servo2(1, 0, C1, 10, 210, 10 Sek)                                                                           /* Excel row 4                                                                                                                                                                                 */
  ConstRGB(2, SI_1, 0, 0, 0, 127, 127, 127)                                                                   /* Excel row 5                                                                                                                                                                                 */
  ConstRGB(3, SI_1, 0, 0, 0, 0, 127, 0)                                                                       /* Excel row 6                                                                                                                                                                                 */
  ConstRGB(4, 2, 0, 0, 0, 0, 0, 64)                                                                           /* Excel row 7                                                                                                                                                                                 */
  ConstRGB(14, SI_1, 0, 0, 0, 0, 0, 64)                                                                       /* Excel row 8                                                                                                                                                                                 */
  ConstRGB(15, SI_1, 0, 0, 0, 0, 0, 64)                                                                       /* Excel row 9                                                                                                                                                                                 */
  ConstRGB(16, SI_1, 0, 0, 0, 0, 0, 64)                                                                       /* Excel row 10                                                                                                                                                                                */
  ConstRGB(17, SI_1, 0, 0, 0, 0, 0, 64)                                                                       /* Excel row 11                                                                                                                                                                                */
  ConstRGB(18, SI_1, 0, 0, 0, 0, 0, 64)                                                                       /* Excel row 12                                                                                                                                                                                */
  ConstRGB(19, SI_1, 0, 0, 0, 0, 0, 64)                                                                       /* Excel row 13                                                                                                                                                                                */
...
const PROGMEM Store_Channel_T Store_Values[] =
         { // Mode + InCnt , Channel
           { IS_TOGGLE + 1 , INCH_DCC_101_ONOFF  },      // Excel row 7
         };
