...
// File creation: 02/11/24 17:59:08
...
#define START_MSG "LEDs_AutoProg Ver 1: 02.11.24 17:59"
...
MobaLedLib_Configuration()
  ...
  ConstRGB(1, 0, 0, 241, 0, 255, 145, 0)                                                                      /* Excel row 5                                                                                                                                                                                 */
  ConstRGB(2, 1, 0, 1, 0, 255, 1, 0)                                                                          /* Excel row 6                                                                                                                                                                                 */
  ConstRGB(3, SI_1, 0, 241, 0, 255, 145, 0)                                                                   /* Excel row 8                                                                                                                                                                                 */
  RGB_Heartbeat(4)                                                                                            /* Excel row 9                                                                                                                                                                                 */
...
const PROGMEM Store_Channel_T Store_Values[] =
         { // Mode + InCnt , Channel
           ...
           { IS_TOGGLE + 1 , INCH_DCC_101_ONOFF  },      // Excel row 6
         };
