...
// File creation: 06/01/24 11:41:04
...
#define START_MSG "LEDs_AutoProg Ver 1: 06.01.24 11:41"
...
#endif
         { // Addr & Typ    InCnt
           { 102  + S_ONOFF,   1 },      // LED auf dem Mainboard
           { 103  + S_ONOFF,   1 },      // Excel row 10
         };


// Input channel defines for local inputs and expert users
#define INCH_DCC_102_ONOFF      0      // LED auf dem Mainboard
#define INCH_DCC_103_ONOFF      1      // Excel row 10
...
MobaLedLib_Configuration()
  {
  ConstRGB(0, 0, 0, 0, 0, 127, 127, 127)                                                                      /* LED auf dem Mainboard                                                                                                                                                                       */
  AndreaskrLT_RGB(1, 1, 150, 800 ms, 200 ms, 300 ms)                                                          /* Excel row 10                                                                                                                                                                                */
...
const PROGMEM Store_Channel_T Store_Values[] =
         { // Mode + InCnt , Channel
           { IS_TOGGLE + 1 , INCH_DCC_102_ONOFF  },      // LED auf dem Mainboard
