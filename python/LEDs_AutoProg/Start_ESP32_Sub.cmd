@ECHO OFF
REM This file was generated by 'Prog_Generator_MobaLedLib.xlsm'  14:30:45
...
REM This will tace up to 3 minutes. When the ESP is updated the next time only
...
if not exist MyPrivateBuildScript.cmd (
       ...
       call :build "C:\Program Files (x86)\Arduino\" "LEDs_AutoProg.ino" COM3 "esp32:esp32:esp32:PSRAM=disabled,PartitionScheme=default,CPUFreq=240,FlashMode=qio,FlashFreq=80,FlashSize=4M,UploadSpeed=921600,DebugLevel=none" 115200  "%ArduinoLib%" esp32 %*
) else (
       REM user defined Build and Upload
       call MyPrivateBuildScript.cmd "C:\Program Files (x86)\Arduino\" "LEDs_AutoProg.ino" COM3 "--board esp32:esp32:esp32:PSRAM=disabled,PartitionScheme=default,CPUFreq=240,FlashMode=qio,FlashFreq=80,FlashSize=4M,UploadSpeed=921600,DebugLevel=none --pref programmer=arduino:arduinoisp" 115200  "%ArduinoLib%" esp32 %*
       )
