...
"C:\Program Files (x86)\Arduino\arduino_debug.exe" "LEDs_AutoProg.ino" --upload --port COM5 --board arduino:avr:nano:cpu=atmega328old --pref build.path="%APPDATA%\..\Arduino_Build_LEDs_AutoProg" --preserve-temp-files
