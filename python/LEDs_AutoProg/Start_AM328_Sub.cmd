...
if not exist MyPrivateBuildScript.cmd (
  ...
  call :build "C:\Program Files (x86)\Arduino\" "LEDs_AutoProg.ino" COM4 "arduino:avr:nano:cpu=atmega328" 115200  "C:\Users\Harold\Documents\Arduino/libraries" atmega328p %*
) else (
  REM user defined Build and Upload
  call MyPrivateBuildScript.cmd "C:\Program Files (x86)\Arduino\" "LEDs_AutoProg.ino" COM4 "arduino:avr:nano:cpu=atmega328" 115200  "C:\Users\Harold\Documents\Arduino/libraries" atmega328p %*
)
