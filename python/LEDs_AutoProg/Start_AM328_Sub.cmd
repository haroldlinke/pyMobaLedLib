...
"C:\Program Files (x86)\Arduino\arduino_debug.exe" "LEDs_AutoProg.ino" --upload --port COM4 --board arduino:avr:uno --pref programmer=arduino:arduinoisp --pref build.path="%APPDATA%\..\Arduino_Build_LEDs_AutoProg" --preserve-temp-files
