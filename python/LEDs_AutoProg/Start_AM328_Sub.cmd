...
"C:\Program Files (x86)\Arduino\arduino_debug.exe" "LEDs_AutoProg.ino" --upload --port COM5  --board arduino:avr:nano:cpu=atmega328old --pref programmer=arduino:arduinoisp --pref build.path="%APPDATA%\..\Arduino_Build_LEDs_AutoProg" --preserve-temp-files
...
xcopy D:\data\Development\pyMLL_tksheet\pyMobaLedLib\python\LEDs_AutoProg\boards.local.txt "C:\Users\Harold\AppData\Local\Arduino15\packages\arduino\hardware\avr\1.8.5\" /d /y >nul
