...
class CSelect_ProgGen_Src_Form:
    ...
    def UserForm_Initialize(self):
        ...
        #Center_Form(Me)
        self.Form=XLF.generate_form(self.Select_ProgGen_Src_Form_RSC,self.controller,dlg=self,modal=False, jump_table=PG.ThisWorkbook.jumptable, defaultfont=X02.DefaultFont)
