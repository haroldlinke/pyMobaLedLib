...
class UserForm_PCAnim:
    ...
    def OK_Button_Click(self):
        ...
        #    + str(self.Servo_Abstand_TextBox.Value) + ","\
        #    + str(self.Servo_Anfangswert_TextBox.Value) + "," + str(self.Servo_Endwert_TextBox.Value) + ","\
        #    + str(self.Servo_DauerEin_TextBox.Value) + "," + str(self.Servo_DauerAus_TextBox.Value) + ","\
        #    + str(self.Servo_PauseS_Ein_TextBox.Value) + "," + str(self.Servo_PauseE_Ein_TextBox.Value) + ","\
        #    + str(self.Servo_PauseS_Aus_TextBox.Value) + "," + str(self.Servo_PauseE_Aus_TextBox.Value)
