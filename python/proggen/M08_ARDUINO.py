...
def Create_ARDUINO_IDE_Cmd(ResultName, ComPort, BuildOptions, InoName, Mode, SrcDir, CPUType):
    ...
    arduino_exe_dir = r'C:\Program Files (x86)/Arduino/'
    arduino_builder_exe = r'"' + arduino_exe_dir + r'arduino-builder"'
    arduino_packages_dir = r'C:\Users/Harold/AppData/Local/Arduino15/packages/'
    arduino_esptool_exe = r'"C:\Users/Harold/AppData/Local/Arduino15/packages/esp32/tools/esptool_py/' + Tool_Version + r'/esptool.exe"'
    arduino_hardware_tools_dir = r'C:\Users/Harold/AppData/Local/Arduino15/packages/esp32/hardware/esp32/' + Board_Version + r'/tools/'
    arduino_temp_dir = r'C:\Users/Harold/AppData/Local/Temp/MobaLedLib_build/'
    arduino_user_lib_dir = r'C:\Users\Harold\Documents\Arduino/libraries/'
...
def Compile_and_Upload_Prog_to_Arduino(InoName, ComPortColumn, BuildOptColumn, SrcDir,CreateFilesOnly=False): # 20.12.21: Jürgen add CreateFilesOnly for programatically generation of header files
    ...
    if CPUType != '':
        StatusMsg_UserForm.ShowDialog(Replace(M09.Get_Language_Str('Programmiere #1# Arduino'), '#1#', ArduName) + vbCr + FileNameExt(InoName) + vbCr + CPUType, '...')
