...
def Create_WriteFastBootloader_cmd(SrcDir):
    ...
    VBFiles.writeText(fp, 'REM', '\n')
    VBFiles.writeText(fp, 'REM This file was automatically generated by the program ' + P01.ThisWorkbook.Name + ' ' + M02.Prog_Version + '      by Hardi', '\n')
    ...
    VBFiles.writeText(fp, '   "-Uflash:w:' + M08.GetShortPath(M02.Get_SrcDirInLib() + 'ArduinoISP\\optiboot_atmega328_Ver108.1.hex') + ':i" ^', '\n')
...
def __Test_Create_WriteFastBootloader_cmd():
    #UT---------------------------------------------------------
    Debug.Print(Create_WriteFastBootloader_cmd(P01.ThisWorkbook.Path + '\\ArduinoISP\\'))
...
def __Write_Bootloader():
    ...
    CmdName = Create_WriteFastBootloader_cmd(P01.ThisWorkbook.Path + '\\ArduinoISP\\')
    if CmdName == '':
        return fn_return_value
